...
import all from './services_booking/all';
import details from './services_booking/details';
import soft_delete from './services_booking/soft_delete';
import store from './services_booking/store';
import { responseObject } from '../../common_types/object';
import update from './services_booking/update';
import restore from './services_booking/restore';
import destroy from './services_booking/destroy';
import block from './services_booking/block';
import data_import from './services_booking/import';
