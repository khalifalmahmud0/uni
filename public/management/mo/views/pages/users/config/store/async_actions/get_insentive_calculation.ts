...
const fetch_api = async (param: anyObject, thunkAPI) => {
    ...
    const response = await axios.get(`${end_point}/users/34/insentive-calculation`);
...
export const get_insentive_calculation = createAsyncThunk<ReturnType, PayloadType, ThunkArgument>(
    `${store_prefix}/insentive_calculation`,
    fetch_api,
);
